...
public class KeyHandler implements KeyListener {
    ...
    public boolean fulfillPressed;      // 2 — fulfill order (red/blue) or toggle restock panel (green)
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (code == KeyEvent.VK_UP)   upArrow   = true;
        if (code == KeyEvent.VK_DOWN) downArrow = true;

        if (code == KeyEvent.VK_SHIFT)      boostPressed        = true;
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (code == KeyEvent.VK_UP)   upArrow   = false;
        if (code == KeyEvent.VK_DOWN) downArrow = false;

        if (code == KeyEvent.VK_SHIFT)      boostPressed        = false;
        ...
        if (code >= KeyEvent.VK_0 && code <= KeyEvent.VK_9) lastDigit = -1;
    }
}