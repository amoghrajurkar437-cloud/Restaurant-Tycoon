...
public class Gamepanel extends JPanel implements Runnable {
    ...
    public int blueCustomers = 0;
    public int redCustomers = 0;
    ...
    public void checkCustomerCollisions() {
        blueCustomers = 0;
        redCustomers = 0;
        for (int i = 0; i < customersIndex; i++) {
            if (customers[i].path ==1){
                blueCustomers++;
            }
            if(customers[i].path==2){
                redCustomers++;
            }
        }
    }
    ...
    public void update() {
        ...
        if (currentTime - lastCustomerSpawnTime >= customerSpawnInterval) {
            ...
            System.out.println(redCustomers);
            System.out.println(blueCustomers);
        }
